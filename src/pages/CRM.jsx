                                                    ...
                                                    <div className="flex justify-between items-start mb-6 border-b border-white/5 pb-4">
                                                        ...
                                                        <div className="text-right">
                                                            <div className="flex gap-2 mb-2 justify-end">
                                                                <a
                                                                    href={`https://console.firebase.google.com/project/${db.app.options.projectId}/firestore/databases/-default-/data/users/${u.id}`}
                                                                    target="_blank"
                                                                ...
                                                                <a
                                                                    href={`https://console.firebase.google.com/project/${db.app.options.projectId}/storage/bucket/${db.app.options.storageBucket}/files/~2Fuser_uploads~2F${u.id}`}
                                                                    target="_blank"
                                                                    rel="noopener noreferrer"
